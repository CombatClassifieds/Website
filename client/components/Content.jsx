    ...
    <div id="content">
      ...
      {/* <ul className="dropdowns">
                        ...
                        <div id="ocsRangerSchool">
                            <ul className="subList">
                                <li className="subListItem">
                                    <a className="ocsRangerItems" href="https://rangerjoes.com/ocs-ranger-school/">All OCS & Ranger School</a>
                                </li>
                                <li className="subListItem">
                                    <a className="ocsRangerItems" href="https://rangerjoes.com/field-equipment/ocs/">OCS - Click Here</a>
                                </li>
                                <li className="subListItem">
                                    <a className="ocsRangerItems" href="https://rangerjoes.com/field-equipment/ranger-school/">Ranger School - Click Here</a>
                                </li>
                            </ul>
                        </div>
                    </li>
                    <li className="navPage-item">
                        <a className="navPage-action" href="https://rangerjoes.com/rotc-jrotc-items/">ROTC/JROTC Items</a>
                    </li>
                    <li className="navPage-item">
                        <a className="navPage-action" href="https://rangerjoes.com/clothing/">Clothing</a>
                    </li>
                    <li className="navPage-item">
                        <a className="navPage-action" href="https://rangerjoes.com/clothing/">Clothing</a>
                        <div className="navPageSubMenuItems">
                            <ul className="navPage-item">
                                <li className="navPageItem">
                                    <a className="navPage-action" href="https://rangerjoes.com/clothing/">All Clothing</a>
                                </li>
                                <li className="navPageItem">
                                    <a className="navPage-action" href="https://rangerjoes.com/clothing/belts/">Belts</a>
                                </li>
                                <li className="navPageItem">
                                    <a className="navPage-action" href="https://rangerjoes.com/clothing/tru-spec-hot-weather-ocp-uniforms/">Hot Weatehr OCP Uniforms</a>
                                    <ul className="navPage-childList">
                                        <li className="navPageItem">
                                            <a className="navPage-action" href="https://rangerjoes.com/clothing/tru-spec-hot-weather-ocp-uniforms/">All Hot Weather OCP Uniforms</a>
                                        </li>
                                        <li className="navPageItem">
                                            <a className="navPage-action" href="https://rangerjoes.com/clothing/hot-weather-ocp-uniforms/propper/">Propper</a>
                                        </li>
                                        <li className="navPageItem">
                                            <a className="navPage-action" href="https://rangerjoes.com/clothing/hot-weather-ocp-uniforms/tru-spec/">Tru-Spec</a>
                                        </li>
                                    </ul>
                                </li>
                                <li className="navPageItem">
                                    <a className="navPage-action" href="https://rangerjoes.com/clothing/gloves/">Gloves</a>
                                </li>
                                <li className="navPageItem">
                                    <a className="navPage-action" href="https://rangerjoes.com/clothing/jackets-rainwear/">Jackets, Rainwear</a>
                                </li>
                                <li className="navPageItem">
                                    <a className="navPage-action" href="https://rangerjoes.com/clothing/kids/">Kids</a>
                                </li>
                                <li className="navPageItem">
                                    <a className="navPage-action" href="https://rangerjoes.com/clothing/p-t/">P.T.</a>
                                </li>
                                <li className="navPageItem">
                                    <a className="navPage-action" href="https://rangerjoes.com/clothing/t-shirts-sweatshirts/">T-Shirts, Sweatshirts</a>
                                </li>
                                <li className="navPageItem">
                                    <a className="navPage-action" href="https://rangerjoes.com/clothing/underwear/">Underwear</a>
                                </li>
                                <li className="navPageItem">
                                    <a className="navPage-action" href="https://rangerjoes.com/clothing/uniforms-female/">Uniforms-Female</a>
                                </li>
                                <li className="navPageItem">
                                    <a className="navPage-action" href="https://rangerjoes.com/clothing/uniforms/">Uniforms</a>
                                </li>
                                <li className="navPageItem">
                                    <a className="navPage-action" href="https://rangerjoes.com/clothing/vests/">Vests</a>
                                </li>
                            </ul>
                        </div>
                    </li>
                    <li className="navPages-item">
                        <a className="navPage-action" href="https://rangerjoes.com/uniform-accessories/">Uniform Accessories</a>
                        <div className="navPageSubMenuItems">
                            <ul className="navPage-subMenu-list">
                    ...
                    <li class="navPages-item">
                        ...
                        <li class="navPages-item">
                            <a class="navPages-action has-subMenu navPages-action--vertical" href="https://rangerjoes.com/eyewear/" data-collapsible="navPages-51-sidebar" data-collapsible-disabled-state="open" data-collapsible-enabled-state="closed" aria-expanded="false" aria-controls="navPages-51-sidebar">
    Eyewear <i class="icon navPages-action-moreIcon" aria-hidden="true"><svg><use href="#icon-chevron-down"></use></svg></i>
</a>
<div class="navPage-subMenu navPage-subMenu--vertical" id="navPages-51-sidebar" aria-hidden="true" tabindex="-1">
        ...
        <li class="navPage-subMenu-item">
            ...
            <li class="navPage-subMenu-item">
                    <a class="navPage-subMenu-action navPages-action" href="https://rangerjoes.com/eyewear/rx/" data-instantload="">Rx</a>
                        ...
                        <li class="navPages-item">
                            <a class="navPages-action has-subMenu navPages-action--vertical" href="https://rangerjoes.com/field-equipment/" data-collapsible="navPages-27-sidebar" data-collapsible-disabled-state="open" data-collapsible-enabled-state="closed" aria-expanded="false" aria-controls="navPages-27-sidebar">
    Field Equipment <i class="icon navPages-action-moreIcon" aria-hidden="true"><svg><use href="#icon-chevron-down"></use></svg></i>
</a>
<div class="navPage-subMenu navPage-subMenu--vertical" id="navPages-27-sidebar" aria-hidden="true" tabindex="-1">
    <ul class="navPage-subMenu-list">
        <li class="navPage-subMenu-item">
            ...
            <li class="navPage-subMenu-item">
                    <a class="navPage-subMenu-action navPages-action" href="https://rangerjoes.com/uniform-accessories/wallets-id-holders/" data-instantload="">Wallets/ID Holders</a>
                        ...
                        <li class="navPages-item">
                            <a class="navPages-action has-subMenu navPages-action--vertical" href="https://rangerjoes.com/flashlights/" data-collapsible="navPages-56-sidebar" data-collapsible-disabled-state="open" data-collapsible-enabled-state="closed" aria-expanded="false" aria-controls="navPages-56-sidebar">
    Flashlights <i class="icon navPages-action-moreIcon" aria-hidden="true"><svg><use href="#icon-chevron-down"></use></svg></i>
</a>
<div class="navPage-subMenu navPage-subMenu--vertical" id="navPages-56-sidebar" aria-hidden="true" tabindex="-1">
    <ul class="navPage-subMenu-list">
        <li class="navPage-subMenu-item">
            ...
            <li class="navPage-subMenu-item">
                    <a class="navPage-subMenu-action navPages-action" href="https://rangerjoes.com/flashlights/led/" data-instantload="">LED</a>
                        ...
                        <li class="navPages-item">
                            <a class="navPages-action has-subMenu navPages-action--vertical" href="https://rangerjoes.com/footwear-accessories/" data-collapsible="navPages-29-sidebar" data-collapsible-disabled-state="open" data-collapsible-enabled-state="closed" aria-expanded="false" aria-controls="navPages-29-sidebar">
    Footwear &amp; Accessories <i class="icon navPages-action-moreIcon" aria-hidden="true"><svg><use href="#icon-chevron-down"></use></svg></i>
</a>
        ...
        <li class="navPage-subMenu-item">
            ...
            <li class="navPage-subMenu-item">
                    <a class="navPage-subMenu-action navPages-action" href="https://rangerjoes.com/footwear-accessories/shoes/" data-instantload="">Shoes</a>
                        ...
                        <li class="navPages-item">
                            <a class="navPages-action has-subMenu navPages-action--vertical" href="https://rangerjoes.com/gifts-novelty-books-manuals/" data-collapsible="navPages-90-sidebar" data-collapsible-disabled-state="open" data-collapsible-enabled-state="closed" aria-expanded="false" aria-controls="navPages-90-sidebar">
    Gifts, Novelty, Books/Manuals <i class="icon navPages-action-moreIcon" aria-hidden="true"><svg><use href="#icon-chevron-down"></use></svg></i>
</a>
<div class="navPage-subMenu navPage-subMenu--vertical" id="navPages-90-sidebar" aria-hidden="true" tabindex="-1">
    <ul class="navPage-subMenu-list">
        <li class="navPage-subMenu-item">
            ...
            <li class="navPage-subMenu-item">
                    <a class="navPage-subMenu-action navPages-action" href="https://rangerjoes.com/gifts-novelty/watches/" data-instantload="">Watches</a>
                        ...
                        <li class="navPages-item">
                            <a class="navPages-action has-subMenu navPages-action--vertical" href="https://rangerjoes.com/headwear/" data-collapsible="navPages-24-sidebar" data-collapsible-disabled-state="open" data-collapsible-enabled-state="closed" aria-expanded="false" aria-controls="navPages-24-sidebar">
    Headwear <i class="icon navPages-action-moreIcon" aria-hidden="true"><svg><use href="#icon-chevron-down"></use></svg></i>
</a>
<div class="navPage-subMenu navPage-subMenu--vertical" id="navPages-24-sidebar" aria-hidden="true" tabindex="-1">
    <ul class="navPage-subMenu-list">
        <li class="navPage-subMenu-item">
            ...
            <li class="navPage-subMenu-item">
                    <a class="navPage-subMenu-action navPages-action" href="https://rangerjoes.com/headwear/watch-caps-beenies/" data-instantload="">Watch Caps, Beenies </a>
                        ...
                        <li class="navPages-item">
                            <a class="navPages-action has-subMenu navPages-action--vertical" href="https://rangerjoes.com/knives-tools/" data-collapsible="navPages-108-sidebar" data-collapsible-disabled-state="open" data-collapsible-enabled-state="closed" aria-expanded="false" aria-controls="navPages-108-sidebar">
    Knives &amp; Tools <i class="icon navPages-action-moreIcon" aria-hidden="true"><svg><use href="#icon-chevron-down"></use></svg></i>
</a>
<div class="navPage-subMenu navPage-subMenu--vertical" id="navPages-108-sidebar" aria-hidden="true" tabindex="-1">
    <ul class="navPage-subMenu-list">
        <li class="navPage-subMenu-item">
            ...
            <li class="navPage-subMenu-item">
                    <a class="navPage-subMenu-action navPages-action" href="https://rangerjoes.com/knives-tools/tools/" data-instantload="">Tools</a>
                        ...
                        <li class="navPages-item">
                            <a class="navPages-action has-subMenu navPages-action--vertical" href="https://rangerjoes.com/tactical-gear/" data-collapsible="navPages-123-sidebar" data-collapsible-disabled-state="open" data-collapsible-enabled-state="closed" aria-expanded="false" aria-controls="navPages-123-sidebar">
    Tactical Gear <i class="icon navPages-action-moreIcon" aria-hidden="true"><svg><use href="#icon-chevron-down"></use></svg></i>
</a>
<div class="navPage-subMenu navPage-subMenu--vertical" id="navPages-123-sidebar" aria-hidden="true" tabindex="-1">
    <ul class="navPage-subMenu-list">
        <li class="navPage-subMenu-item">
            ...
            <li class="navPage-subMenu-item">
                    <a class="navPage-subMenu-action navPages-action" href="https://rangerjoes.com/tactical-gear/vests/" data-instantload="">Vests</a>
                        ...
                        <li class="navPages-item">
                            <a class="navPages-action has-subMenu navPages-action--vertical" href="https://rangerjoes.com/weapons-accessories/" data-collapsible="navPages-161-sidebar" data-collapsible-disabled-state="open" data-collapsible-enabled-state="closed" aria-expanded="false" aria-controls="navPages-161-sidebar">
    Weapons Accessories <i class="icon navPages-action-moreIcon" aria-hidden="true"><svg><use href="#icon-chevron-down"></use></svg></i>
</a>
<div class="navPage-subMenu navPage-subMenu--vertical" id="navPages-161-sidebar" aria-hidden="true" tabindex="-1">
    <ul class="navPage-subMenu-list">
        <li class="navPage-subMenu-item">
            ...
            <li class="navPage-subMenu-item">
                    <a class="navPage-subMenu-action navPages-action" href="https://rangerjoes.com/weapons-accessories/bipods/" data-instantload="">Bipods</a>
            </li>
            <li class="navPage-subMenu-item">
            ...
            <li class="navPage-subMenu-item">
                    <a class="navPage-subMenu-action navPages-action" href="https://rangerjoes.com/weapons-accessories/magazines-accessories/" data-instantload="">Magazines &amp; Accessories</a>
            </li>
            <li class="navPage-subMenu-item">
